...
class ArticleList: ObservableObject {
    ...
    let sampleCards: [ArticleCard] = [
        ArticleCard(title: "探索AI的无限可能", author: "科技前沿", contentURL: "https://example.com", category: "科技", readingTime: 5, likes: 324, isBookmarked: false, excerpt: "人工智能正在重塑我们的世界..."),
        ArticleCard(title: "青春旅行指南", author: "旅行达人", contentURL: "https://example.com", category: "旅行", readingTime: 8, likes: 567, isBookmarked: true, excerpt: "背上行囊，开启一场说走就走的旅行..."),
        ArticleCard(title: "健康生活新主张", author: "健康专家", contentURL: "https://example.com", category: "健康", readingTime: 6, likes: 423, isBookmarked: false, excerpt: "在快节奏的现代生活中..."),
        ArticleCard(title: "美食探店指南", author: "美食家", contentURL: "https://example.com", category: "美食", readingTime: 4, likes: 289, isBookmarked: true, excerpt: "每个城市都有隐藏的美食宝地..."),
        ArticleCard(title: "大学生活攻略", author: "学长学姐", contentURL: "https://example.com", category: "教育", readingTime: 7, likes: 612, isBookmarked: false, excerpt: "大学四年是人生中最宝贵的时光...")
    ]
    ...
    func fetchData() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            ...
            self.recentArticles = Array(self.sampleCards.suffix(4))
